-- ============================================================
-- CLEANER v5.2 – KEYBINDS PARA TODOS LOS BOTONES Y FUNCIONES
-- (Versión compacta vertical, colores AZUL CLARO/OSCURO)
-- ============================================================
...
-- ============================================================
-- PRESETS, CONFIG, POSICIONES (renombrados a Cleaner)
-- ============================================================
local Presets = {}
local PRESET_FILE = "CleanerPresets.json"
local LAST_PRESET_FILE = "CleanerLastPreset.json"
local CONFIG_FILE = "CleanerConfig.json"
local POSITIONS_FILE = "CleanerPositions.json"
local BATV2_POS_FILE = "CleanerBatV2Pos.json"
...
-- ============================================================
-- COLORES AZUL CLARO / OSCURO (sin verde y sin lag)
-- ============================================================
local WHITE_PURE = Color3.fromRGB(255, 255, 255)
local BLACK_PURE = Color3.fromRGB(0, 0, 0)
local BLUE_ACCENT = Color3.fromRGB(79, 195, 247)          -- azul claro
local DARK_BLUE_BG = Color3.fromRGB(10, 26, 43)          -- fondo principal azul oscuro
local ROW_BG = Color3.fromRGB(26, 58, 90)                -- azul medio para filas
local TOGGLE_BAR_BG = Color3.fromRGB(8, 20, 35)          -- barra flotante
local MOBILE_BTN_BG = Color3.fromRGB(20, 50, 80)         -- azul oscuro para botones móviles
local MOBILE_BTN_ACTIVE = BLUE_ACCENT                    -- azul al activarse
local LIGHT_BLUE = Color3.fromRGB(150, 215, 245)
local DARK_BLUE = Color3.fromRGB(5, 15, 25)
local BLUE_INPUT_BG = Color3.fromRGB(40, 80, 120)        -- azul para inputs

local C = {
    winBg = DARK_BLUE_BG, winBorder = BLUE_ACCENT,
    topBg = DARK_BLUE_BG, topTitle = LIGHT_BLUE,
    topSub = LIGHT_BLUE, topBtn = BLUE_ACCENT,
    topBtnHov = WHITE_PURE, topDivider = BLUE_ACCENT,
    tabBarBg = DARK_BLUE_BG, tabBarDiv = BLUE_ACCENT,
    tabIdle = LIGHT_BLUE, tabActive = WHITE_PURE,
    tabActiveBg = DARK_BLUE_BG, tabUnderline = BLUE_ACCENT,
    sectionTxt = LIGHT_BLUE, sectionDiv = BLUE_ACCENT,
    rowBg = ROW_BG, rowBorder = BLUE_ACCENT,
    rowLabel = LIGHT_BLUE, rowSub = LIGHT_BLUE,
    rowValue = WHITE_PURE, rowHov = DARK_BLUE,
    inputBg = BLUE_INPUT_BG, inputBorder = BLUE_ACCENT,
    inputFocus = BLUE_ACCENT, inputTxt = WHITE_PURE,
    pillOff = DARK_BLUE, pillOn = BLUE_ACCENT,
    dotOff = DARK_BLUE, dotOn = WHITE_PURE,
    pillBorder = BLUE_ACCENT,
    modeBtnBg = DARK_BLUE_BG, modeBtnBrd = BLUE_ACCENT,
    modeBtnTxt = LIGHT_BLUE, modeBtnActBg = BLUE_ACCENT,
    modeBtnActTx = BLACK_PURE,
    chipBg = BLUE_INPUT_BG, chipBorder = BLUE_ACCENT,
    chipTxt = WHITE_PURE,
    btnBg = DARK_BLUE_BG, btnBorder = BLUE_ACCENT,
    btnTxt = LIGHT_BLUE, btnHov = BLUE_ACCENT,
    stackBg = WHITE_PURE, stackBrd = BLACK_PURE,
    stackTxt = BLACK_PURE, stackActBg = BLUE_ACCENT,
    stackActTxt = BLACK_PURE, stackDot = WHITE_PURE,
    stackDotOn = BLUE_ACCENT,
    infoBg = DARK_BLUE_BG, infoBrd = BLUE_ACCENT,
    infoTxt = LIGHT_BLUE, infoVal = WHITE_PURE,
    infoFill = BLUE_ACCENT, accent = BLUE_ACCENT,
    accentDim = BLUE_ACCENT, presetBg = DARK_BLUE_BG,
    presetBrd = BLUE_ACCENT, presetLoad = BLUE_ACCENT,
    presetDel = BLUE_ACCENT, delBrd = BLUE_ACCENT,
    lockOn = BLUE_ACCENT, divider = BLUE_ACCENT,
    toggleBarBg = TOGGLE_BAR_BG, toggleBarBorder = BLUE_ACCENT,
...
-- ============================================================
for _, name in pairs({ "VyseSlottedGUI", "VyseAsireGUI", "VyseAsireHubV4", "VyseAsireHubV5", "VyseAsireHubV5_1", "AsireHubV5_1", "AsireHubV5_2", "OpiumGGV5_2", "SaskHubV5_2", "CleanHubV5_2", "CleanerV5_2" }) do
...
-- ============================================================
-- BARRA FLOTANTE TOGGLE (CLEANER)
-- ============================================================
local toggleBar = Instance.new("Frame", gui)
toggleBar.Name = "CleanerToggle"
...
local function createProgressBar()
    ...
    pbFrame.BackgroundColor3 = DARK_BLUE_BG
    pbFrame.BorderSizePixel = 0
    pbFrame.Active = true
    pbFrame.ZIndex = 15
    mkCorner(pbFrame, 8)
    mkStroke(pbFrame, BLUE_ACCENT, 1)
    ...
    pbBg.BackgroundColor3 = DARK_BLUE_BG
    pbBg.BorderSizePixel = 0
    mkCorner(pbBg, 4)
    mkStroke(pbBg, BLUE_ACCENT, 1)

    progressFill = Instance.new("Frame", pbBg)
    progressFill.Size = UDim2.new(0, 0, 1, 0)
    progressFill.BackgroundColor3 = BLUE_ACCENT
...
-- ============================================================
-- CONTENEDOR MÓVIL PRINCIPAL (8 BOTONES) – Color azul, activo azul claro
-- ============================================================
...
for idx, def in ipairs(buttonDefs) do
    ...
    btnFrame.BackgroundColor3 = MOBILE_BTN_BG   -- azul oscuro
    btnFrame.BorderSizePixel = 0
    btnFrame.ZIndex = 16
    mkCorner(btnFrame, 14)
    local stroke = mkStroke(btnFrame, BLUE_ACCENT, 1)
...
-- ============================================================
-- BOTÓN BAT V2 INDEPENDIENTE (también azul)
-- ============================================================
...
local strokeV2 = mkStroke(batV2Frame, BLUE_ACCENT, 1)
...
-- ============================================================
-- EFECTO DE CLIMA (ELIMINADO – ya no causa lag)
-- ============================================================
-- (La función applyWeatherEffect fue removida completamente)
...
-- ============================================================
-- CHARACTER SETUP (con marcador de velocidad azul)
-- ============================================================
local function setupChar(char)
    ...
    if head then
        ...
        speedBillLbl.TextColor3 = BLUE_ACCENT
...
loadConfig()
initializeScanner()
-- applyWeatherEffect()  -- ELIMINADO: ya no hay efecto climático
